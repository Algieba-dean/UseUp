...
extension LocationQueryWhereSort on QueryBuilder<Location, Location, QWhere> {
  ...
  QueryBuilder<Location, Location, QAfterWhere> anyName() {
    return QueryBuilder.apply(this, (query) {
...
extension LocationQueryWhere on QueryBuilder<Location, Location, QWhereClause> {
  ...
  QueryBuilder<Location, Location, QAfterWhereClause> nameGreaterThan(
    String name, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Location, Location, QAfterWhereClause> nameLessThan(
    String name, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Location, Location, QAfterWhereClause> nameBetween(
    String lowerName,
    String upperName, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Location, Location, QAfterWhereClause> nameStartsWith(
      String NamePrefix) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.between(
        indexName: r'name',
  ...
  QueryBuilder<Location, Location, QAfterWhereClause> nameIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'name',
        value: [''],
  ...
  QueryBuilder<Location, Location, QAfterWhereClause> nameIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
...
extension LocationQueryFilter
  ...
  QueryBuilder<Location, Location, QAfterFilterCondition> levelEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'level',
  ...
  QueryBuilder<Location, Location, QAfterFilterCondition> levelGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Location, Location, QAfterFilterCondition> levelLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Location, Location, QAfterFilterCondition> levelBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension LocationQuerySortBy on QueryBuilder<Location, Location, QSortBy> {
  QueryBuilder<Location, Location, QAfterSortBy> sortByLevel() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'level', Sort.asc);
    });
  }

  QueryBuilder<Location, Location, QAfterSortBy> sortByLevelDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension LocationQuerySortThenBy
  ...
  QueryBuilder<Location, Location, QAfterSortBy> thenByLevel() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'level', Sort.asc);
    });
  }

  QueryBuilder<Location, Location, QAfterSortBy> thenByLevelDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'level', Sort.desc);
    });
  }
...
extension LocationQueryWhereDistinct
  ...
  QueryBuilder<Location, Location, QDistinct> distinctByLevel() {
    return QueryBuilder.apply(this, (query) {
...
extension LocationQueryProperty
  ...
  QueryBuilder<Location, int, QQueryOperations> levelProperty() {
    return QueryBuilder.apply(this, (query) {
