...
extension AppSettingQuerySortBy
  ...
  QueryBuilder<AppSetting, AppSetting, QAfterSortBy> sortByLanguageCode() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'languageCode', Sort.asc);
    });
  }

  QueryBuilder<AppSetting, AppSetting, QAfterSortBy> sortByLanguageCodeDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension AppSettingQuerySortThenBy
  ...
  QueryBuilder<AppSetting, AppSetting, QAfterSortBy> thenByLanguageCode() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'languageCode', Sort.asc);
    });
  }

  QueryBuilder<AppSetting, AppSetting, QAfterSortBy> thenByLanguageCodeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'languageCode', Sort.desc);
    });
  }
...
extension AppSettingQueryWhereDistinct
  ...
  QueryBuilder<AppSetting, AppSetting, QDistinct> distinctByLanguageCode(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension AppSettingQueryProperty
  ...
  QueryBuilder<AppSetting, String?, QQueryOperations> languageCodeProperty() {
    return QueryBuilder.apply(this, (query) {
